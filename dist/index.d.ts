...
export { SchemaAdapter, type MappedSchemaSpec, type MappedNodeSpec, type MappedMarkSpec, type BlockMappingSpec, } from "./schema.js";
 ...
 * ```
 */
export declare function init(handle: DocHandle<unknown>, pathToTextField: A.Prop[], options?: {
